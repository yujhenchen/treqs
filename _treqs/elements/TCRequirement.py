...
class TCRequirement(Requirement.Requirement):
    ...
    def createElement(self, content, uid, link_sr, link_element, email, dateTime):
        return (Requirement.element(content, id=uid, type=param.tcReq, link_sr=link_sr, link_element=link_element, email=email, date=dateTime))
