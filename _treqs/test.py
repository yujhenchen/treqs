...
# from treqs.elements import docRequirement
from _treqs import parameters
from _treqs.functions import generateReq
from _treqs.functions import generateReqDoc
from _treqs.functions import checkConsistency
import os
import shutil
import ntpath
import re
...
# read batabase
# main table
# processObj = UseRequirement.UseRequirement()
...
# # elements doc
# docP = docRequirement.docRequirement()
